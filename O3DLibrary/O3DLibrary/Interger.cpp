...
O3DLIBRAIRY_API Core::PrimitiveType::Integer Core::PrimitiveType::Integer::Parse(const FString& _str)
{
	return std::stoi(_str.ToCstr());
}
O3DLIBRAIRY_API Core::PrimitiveType::Boolean Core::PrimitiveType::Integer::TryParse(const FString& _str, Integer& _out)
{
	try
	{
