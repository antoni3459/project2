...
public:
	...
	static void LogSeparator(const int _count);
	static void Underline(const std::string& _str);
	static void UnderlineDisplay(const std::string& _str);
	static void LogTile(const std::string& _title);
